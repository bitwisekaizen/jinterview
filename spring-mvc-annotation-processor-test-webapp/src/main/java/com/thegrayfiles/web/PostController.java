...
public class PostController {
    ...
    @RequestMapping(value="/canPostFileWithReturnValue", method = RequestMethod.POST)
    public @ResponseBody TestEntity canPostFileWithReturnValue(@RequestParam MultipartFile file, @RequestBody TestEntity testEntity) {
        TestEntity returnValue = new TestEntity();
        returnValue.setFilename(file.getName());
        return returnValue;
    }
}
